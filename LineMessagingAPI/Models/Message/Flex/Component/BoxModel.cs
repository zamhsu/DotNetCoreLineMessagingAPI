...
namespace LineMessagingAPI.Models.Message.Flex.Component
{
    ...
    public class BoxModel : FlexComponentModel
    {
        ...
        /// <summary>
        /// [Required] The layout style of components in this box.
        /// </summary>
        public FlexLayout layout { get; set; }

        /// <summary>
        /// [Required] Models.Flex.Components
        ...
        /// <summary>
        /// [Optional] Background color of the block. Use a hexadecimal color code. (Example:#RRGGBBAA). The default value is #00000000.
        /// </summary>
        public string backgroundColor { get; set; }

        /// <summary>
        /// [Optional] Color of box border. Use a hexadecimal color code.
        /// </summary>
        public string borderColor { get; set; }

        /// <summary>
        /// [Optional] Width of box border.
        ...
        /// <summary>
        /// [Optional] Radius at the time of rounding the corners of the border.
        ...
        /// <summary>
        /// [Optional] Minimum space between components in this box. The default value is none.
        /// </summary>
        ...
        /// <summary>
        /// [Optional] Free space between the borders of this box and the child element.
        /// </summary>
        public string paddingAll { get; set; }

        /// <summary>
        /// [Optional] Free space between the border at the upper end of this box and the upper end of the child element.
        /// </summary>
        public string paddingTop { get; set; }

        /// <summary>
        /// [Optional] Free space between the border at the lower end of this box and the lower end of the child element.
        /// </summary>
        public string paddingBottom { get; set; }

        /// <summary>
        /// [Optional] Free space between the border at the left end of this box and the left end of the child element.
        /// </summary>
        public string paddingStart { get; set; }

        /// <summary>
        /// [Optional] Free space between the border at the right end of this box and the right end of the child element.
        /// </summary>
        public string paddingEnd { get; set; }

        /// <summary>
        /// [Optional] Reference position for placing this box.
